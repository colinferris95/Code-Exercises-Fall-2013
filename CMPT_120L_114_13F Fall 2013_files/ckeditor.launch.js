    ...
    var ckconfig = {
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['ResourceSearch', 'Image','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','fmath_formula']
                : ['Image','Table','HorizontalRule','Smiley','SpecialChar','PageBreak', 'fmath_formula']),
            '/',
		...
		//   CKEDITOR.plugins.addExternal('movieplayer',basePath+'movieplayer/', 'plugin.js'); 
           ...
           CKEDITOR.plugins.addExternal('ckeditor_wiris',basePath+'ckeditor_wiris/', 'plugin.js');
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="wordcount,fmath_formula,aspell,ckeditor_wiris";
    })();
